...
/**
 * Shown when a kitchen user opens a page their capabilities do not cover.
 *
 ...
 * that 403 means the page never renders a shell the caller cannot use, and never
 * shows an empty state that reads as "there is nothing here" when the truth is
